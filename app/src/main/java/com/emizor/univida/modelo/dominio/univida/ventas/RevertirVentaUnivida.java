...
public class RevertirVentaUnivida implements Serializable, Parcelable
{
    ...
    public final static Parcelable.Creator<RevertirVentaUnivida> CREATOR = new Creator<RevertirVentaUnivida>() {


        @SuppressWarnings({
                "unchecked"
        })
        public RevertirVentaUnivida createFromParcel(Parcel in) {
            return new RevertirVentaUnivida(in);
        }

        public RevertirVentaUnivida[] newArray(int size) {
            return (new RevertirVentaUnivida[size]);
        }

    }
            ;
    private final static long serialVersionUID = 1698520026485339756L;

    protected RevertirVentaUnivida(Parcel in) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RevertirVentaUnivida) == false) {
            return false;
        }
        RevertirVentaUnivida rhs = ((RevertirVentaUnivida) other);
