...
public class TipoPlacasRespUnivida implements Serializable, Parcelable
{
    ...
    @Expose
    private List<TipoPlaca> datos = null;
    public final static Parcelable.Creator<TipoPlacasRespUnivida> CREATOR = new Creator<TipoPlacasRespUnivida>() {


        @SuppressWarnings({
                "unchecked"
        })
        public TipoPlacasRespUnivida createFromParcel(Parcel in) {
            return new TipoPlacasRespUnivida(in);
        }

        public TipoPlacasRespUnivida[] newArray(int size) {
            return (new TipoPlacasRespUnivida[size]);
        }
    ...
    protected TipoPlacasRespUnivida(Parcel in) {
        ...
        in.readList(this.datos, (TipoPlaca.class.getClassLoader()));
    }

    public TipoPlacasRespUnivida() {
    }
    ...
    public List<TipoPlaca> getDatos() {
        return datos;
    }

    public void setDatos(List<TipoPlaca> datos) {
        this.datos = datos;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TipoPlacasRespUnivida) == false) {
            return false;
        }
        TipoPlacasRespUnivida rhs = ((TipoPlacasRespUnivida) other);
