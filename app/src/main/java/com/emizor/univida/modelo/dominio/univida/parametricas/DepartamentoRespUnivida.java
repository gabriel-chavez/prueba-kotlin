...
public class DepartamentoRespUnivida implements Serializable, Parcelable
{
    ...
    @Expose
    private List<Departamento> datos = null;

    public final static Parcelable.Creator<DepartamentoRespUnivida> CREATOR = new Creator<DepartamentoRespUnivida>() {


        @SuppressWarnings({
                "unchecked"
        })
        public DepartamentoRespUnivida createFromParcel(Parcel in) {
            return new DepartamentoRespUnivida(in);
        }

        public DepartamentoRespUnivida[] newArray(int size) {
            return (new DepartamentoRespUnivida[size]);
        }

    };

    private final static long serialVersionUID = 3062443084565278711L;

    protected DepartamentoRespUnivida(Parcel in) {
        ...
        in.readList(this.datos, (Departamento.class.getClassLoader()));
    }

    public DepartamentoRespUnivida() {
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DepartamentoRespUnivida) == false) {
            return false;
        }
        DepartamentoRespUnivida rhs = ((DepartamentoRespUnivida) other);
