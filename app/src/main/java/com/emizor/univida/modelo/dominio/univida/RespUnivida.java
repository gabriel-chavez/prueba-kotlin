...
public class RespUnivida implements Serializable, Parcelable
{
    ...
    public final static Parcelable.Creator<RespUnivida> CREATOR = new Creator<RespUnivida>() {


        @SuppressWarnings({
                "unchecked"
        })
        public RespUnivida createFromParcel(Parcel in) {
            return new RespUnivida(in);
        }

        public RespUnivida[] newArray(int size) {
            return (new RespUnivida[size]);
        }
    ...
    protected RespUnivida(Parcel in) {
        ...
        this.datos = ((Object) in.readValue((Object.class.getClassLoader())));
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RespUnivida) == false) {
            return false;
        }
        RespUnivida rhs = ((RespUnivida) other);
