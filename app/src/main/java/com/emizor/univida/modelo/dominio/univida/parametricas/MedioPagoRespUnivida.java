...
public class MedioPagoRespUnivida implements Serializable, Parcelable
{
    ...
    @Expose
    private List<MedioPago> datos = null;
    public final static Parcelable.Creator<MedioPagoRespUnivida> CREATOR = new Creator<MedioPagoRespUnivida>() {


        @SuppressWarnings({
                "unchecked"
        })
        public MedioPagoRespUnivida createFromParcel(Parcel in) {
            return new MedioPagoRespUnivida(in);
        }

        public MedioPagoRespUnivida[] newArray(int size) {
            return (new MedioPagoRespUnivida[size]);
        }

    }
            ;
    private final static long serialVersionUID = 1075884298712001972L;

    protected MedioPagoRespUnivida(Parcel in) {
        ...
        in.readList(this.datos, (MedioPago.class.getClassLoader()));
    }

    public MedioPagoRespUnivida() {
    }
    ...
    public List<MedioPago> getDatos() {
        return datos;
    }

    public void setDatos(List<MedioPago> datos) {
        this.datos = datos;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MedioPagoRespUnivida) == false) {
            return false;
        }
        MedioPagoRespUnivida rhs = ((MedioPagoRespUnivida) other);
