...
import com.beardedhen.androidbootstrap.utils.CustomBootstrapStyle;
import com.beardedhen.androidbootstrap.utils.CustomBootstrapStyle2;
...
public class BootstrapButton extends AwesomeTextView implements BootstrapSizeView,
    ...
    @Override public void setBadge(BootstrapBadge badge) {
        ...
        switch (badge.getTipo_badge()) {
            case 0:
                this.bootstrapBadge.setBootstrapBrand(new CustomBootstrapStyle(badge.getContext()), true);
                break;
            case 1:
                this.bootstrapBadge.setBootstrapBrand(new CustomBootstrapStyle2(badge.getContext()), true);
                break;
        }
