 ...
 */
public class CustomBootstrapStyle2 implements BootstrapBrand {
    ...
    @SuppressWarnings("deprecation") public CustomBootstrapStyle2(Context context) {
        defaultFill = context.getResources().getColor(android.R.color.white);
